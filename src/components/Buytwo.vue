        ...
        <div class="content mar_20">
          <div class="two_bg">
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td align="right"><a v-on:click="addaction"><img src="../assets/images/btn_sure.gif" /></a></td>
              </tr>
            </table>
          </div>
        </div>
...
<script>
    export default {
        ...
        methods: {
             addaction() {
                   axios.post(this.url + '/auth/addaction',{
                       g_id:this.mg,
                       ...
                       .then(res => {
                          ...
                          var token=localStorage.getItem("token")
                           location.href="http://localhost/php/laravel/blog/public/api/pay/index?token="+token+"&id="+res.data.order_id
                       });
             },
        },
        mounted() {
            axios.post(this.url + '/auth/cartwo',{
                g_id: this.mg,
                token: localStorage.getItem("token")
            })
                .then(res => {
            ...
            axios.post(this.url + '/auth/cartwo1',{
                g_id: this.mg,
                token: localStorage.getItem("token")
            })
                .then(res => {
