  ...
  <div class="top">
    ...
    <div class="i_car">
      ...
      <div class="car_bg">
        ...
        <div class="price_a"><a>去购物车结算</a></div>
        <!--End 购物车已登录 End-->
      </div>
    </div>
  </div>
  ...
  <div class="i_bg">
    ...
    <div class="content mar_20">
      <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
        ...
        <tr v-for="(value,key) in cart" align="center">
          <td><input type="checkbox" class="input" name="input"  v-bind:value="value.g_id" v-on:click="checkboxa(value)"></td>
          <td align="center">
            <div class="c_s_img"><img src="../assets/images/c_1.jpg" width="73" height="73" /></div>
            <div align="center">{{value.name}}</div>
          </td>
          <td align="center">属性{{value.attr_name}}</td>
          <td align="center">
            <div class="c_num">
              <input type="button" value="" v-on:click="greed(value.number -=1 ,value.g_id)"   class="car_btn_1" />
<!--                               点击时并且传参，当点减时减一-->
<!--              <span>{{value.number}}</span>-->
              <input type="text" v-bind:value=value.number class="car_ipt" />
              <input type="button" value="" v-on:click="greed(value.number +=1 ,value.g_id)"  class="car_btn_2" />
            </div>
          </td>
        ...
        <tr valign="top" height="150">
          <td colspan="6" align="right">
            <a href="#"><img src="../assets/images/buy1.gif" /></a>&nbsp; &nbsp; <a  v-on:click="buy"><img src="../assets/images/buy2.gif" /></a>
          </td>
        </tr>
      </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            checkboxa: function (value) {            //单选或者多选商品
                console.log(value)
                //通过点击传形参将数组传下来
                var arr=value.g_id;
                //从数组中取出货品id
            ...
            buy(){
                var arr=[]
                //把选中的放入数组中
                $.each(this.cart,function (key,val) {
                    var ary=$('input[name="input"]')
                    //console.log(ary)
                    for(var aa in ary){
                        if(ary[aa].checked) arr.push(ary[aa].value)
                    }
                })
                 //console.log(arr)
                //定义一个新数组，循环原来的数组，把重复的值剔除放入新数组
                var newarr=[]
